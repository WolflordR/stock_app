...
from modules.backtest.strategy_config import BUY_STRATEGY_METADATA, SELL_STRATEGY_METADATA
from modules.ui.ui_state import get_selected_from_dialog_state
