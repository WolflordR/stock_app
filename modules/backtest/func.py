from modules.backtest.backtest_engine import check_stock, get_chinese_name, scan_market
from modules.backtest.bowl_scoring import (
    _clip_score,
    _grade_bowl_score,
    _score_linear,
...
from modules.backtest.performance_metrics import (
    build_equity_curve,
